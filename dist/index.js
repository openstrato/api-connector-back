...
function apiConnector(params) {
    ...
    const providedParams = Object.fromEntries(Object.entries(params).filter(([, value]) => value !== undefined));
    params = Object.assign(Object.assign({}, defaultParams), providedParams);
